...
const i = {
  ...
  createBuffer: function (t, e) {
    ...
    if (("number" == typeof t[0] && (t = [t]), !t[0] || 0 === t[0].length))
...
class g extends e {
  ...
  onContainerResize() {
    ...
    (t === this.lastContainerWidth && "auto" !== this.options.height) ||
      ((this.lastContainerWidth = t), this.reRender(), this.emit("resize"));
  }
  initDrag() {
    this.dragUnsubscribe ||
      ((this.dragUnsubscribe = (function (t, e, i, n, s = 3, r = 0, o = 100) {
        if (!t) return () => {};
        const a = new Map(),
  ...
  renderLineWaveform(t, e, i, n) {
    const { width: s, height: r } = i.canvas,
      o = (function ({ channelData: t, width: e, height: i, vScale: n }) {
        const s = i / 2,
          r = t[0] || [];
  ...
  renderMultiCanvas(t, e, i, n, s, r) {
    ...
    const d = (i) => {
        ...
        })({ channelData: t, offset: o, clampedWidth: a, totalWidth: h });
    ...
    if (
      ...
      const t = this.on("scroll", () => {
        ...
        (Object.keys(c).length > 10 &&
          ...
          m({ scrollLeft: t, totalWidth: h, numCanvases: u }).forEach((t) =>
            d(t),
          ));
      });
...
class v extends e {
  ...
  start() {
    ...
    const t = () => {
      this.isRunning &&
        (this.emit("tick"), (this.animationFrameId = requestAnimationFrame(t)));
    };
    t();
  }
  stop() {
...
class b extends e {
  ...
  _play() {
    ...
    ((this.paused = !1),
      this.bufferNode &&
        ((this.bufferNode.onended = null), this.bufferNode.disconnect()),
    ...
    ((t >= this.duration || t < 0) && ((t = 0), (this.playedDuration = 0)),
      ...
      const e = this.renderer.on("drag", (e) => {
        ...
        (this.isPlaying()
          ...
          : !0 === s
            ...
            : s &&
              "object" == typeof s &&
              (n = null !== (i = s.debounceTime) && void 0 !== i ? i : 200),
          (t = setTimeout(() => {
            this.seekTo(e);
          }, n)),
