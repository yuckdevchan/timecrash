...
<ContextMenu.Root>
	<ContextMenu.Trigger>
		<li
			class="absolute left-{clip.inTrackStart} my-1 flex select-none list-none flex-col rounded-md bg-blue-400"
		>
			<span class="text-ellipsis rounded-t-md bg-blue-900 p-1 text-sm">{clip.mediaItem.name}</span>
			<Waveform {clip} />
		</li>
	</ContextMenu.Trigger>
	<ContextMenu.Content>
